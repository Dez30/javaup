...
![JVM多语言支持](https://oss.javaguide.cn/github/javaguide/java/basis/java-virtual-machine-program-language-os.png)
...
![JDK组成](https://oss.javaguide.cn/github/javaguide/java/basis/jdk-include-jre.png)
...
![代码执行流程](https://oss.javaguide.cn/github/javaguide/java/basis/java-code-to-machine-code.png)
...
![JIT优化](https://oss.javaguide.cn/github/javaguide/java/basis/java-code-to-machine-code-with-jit.png)

> HotSpot VM 采用惰性评估策略,只编译热点代码(基于二八定律),执行次数越多,优化效果越好。

**JDK/JRE/JVM/JIT 关系图**:

![四者关系](https://oss.javaguide.cn/github/javaguide/java/basis/jdk-jre-jvm-jit.png)
