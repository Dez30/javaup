...
![异常类层次](https://oss.javaguide.cn/github/javaguide/java/basis/types-of-exceptions-in-java.png)
...
![ SPI 机制](https://oss.javaguide.cn/github/javaguide/java/basis/spi/22e1830e0b0e4115a882751f6c417857tplv-k3u1fbpfcp-zoom-1.jpeg)
...
![序列化](https://oss.javaguide.cn/github/javaguide/a478c74d-2c48-40ae-9374-87aacf05188c.png)
...
InputStream/Reader  (输入流)
  │
  ├─ FileInputStream/FileReader       (文件)
  ├─ ByteArrayInputStream              (内存数组)
  ├─ BufferedInputStream/BufferedReader (缓冲)
