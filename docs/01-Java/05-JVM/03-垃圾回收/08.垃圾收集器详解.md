...
description: "详解HotSpot主流垃圾收集器:新生代Serial/ParNew/Parallel Scavenge的工作原理;老年代Serial Old/Parallel Old/CMS的回收特点;分析收集器组合模式(Serial+Serial Old/ParNew+CMS/Parallel+Parallel Old);不同JDK版本的默认GC配置。"
