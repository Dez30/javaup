...
description: "Interceptor拦截器接口;四大可拦截对象Executor/StatementHandler/ParameterHandler/ResultSetHandler;@Intercepts/@Signature注解;Plugin.wrap代理生成;分页/SQL监控/数据权限插件实现。"
