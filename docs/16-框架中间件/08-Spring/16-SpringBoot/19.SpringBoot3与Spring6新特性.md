...
description: "JDK 17基线要求;Records/Sealed Classes/文本块;Jakarta EE迁移javax到jakarta包名;AOT预先编译;GraalVM原生镜像;启动速度40倍提升;云原生Serverless支持;HTTP Interface声明式客户端;升级迁移指南。"
