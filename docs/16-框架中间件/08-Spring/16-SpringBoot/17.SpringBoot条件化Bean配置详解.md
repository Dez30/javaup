...
description: "@Conditional与Condition接口;@ConditionalOnProperty配置开关;@ConditionalOnClass/@ConditionalOnMissingClass类路径条件;@ConditionalOnBean/@ConditionalOnMissingBean依赖检查;@ConditionalOnExpression SpEL表达式;@ConfigurationProperties配置绑定;自动装配条件链。"
