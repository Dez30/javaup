...
description: "Spring7/SpringBoot4版本更新;API版本控制原生支持;JSpecify空安全注解;@Retryable内置弹性特性;Jackson 3迁移;JDK 17-25支持;Jakarta EE 11基线;Servlet 6.1/Hibernate 7.1;自动配置模块化。"
