...
description: "详细列举大麦项目的技术选型清单，包括SpringBoot/SpringCloud微服务框架、Nacos注册中心、Sentinel熔断、Redis缓存、Kafka消息队列、Elasticsearch搜索引擎、ShardingSphere分库分表等核心组件，展示基于SpringBoot自动装配的组件库设计理念与业务流程优化。"
