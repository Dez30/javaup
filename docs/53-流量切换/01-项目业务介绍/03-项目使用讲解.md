...
description: "link-flow项目使用指南，包括注册中心（Nacos/Eureka）、配置中心（Apollo/Nacos）、Gateway网关和业务服务的依赖引入方式，支持蓝绿灰度发布、多维度路由过滤、线程池数据隔离等特性。"
keywords: ["link-flow使用", "依赖配置", "注册中心", "配置中心", "灰度发布"]
---
