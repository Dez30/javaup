...
description: "大麦AI项目完整启动指南，包括Git克隆下载、IntelliJ IDEA导入配置、数据库导入、OpenAI和DeepSeek密钥配置、ElasticSearch设置、Vue前端启动流程，以及JDK17和Node.js环境要求说明"
keywords: ["项目启动", "IDEA导入", "数据库配置", "API密钥", "ElasticSearch", "Vue前端启动"]
---
